 ...
 */
    class Upload{
        constructor(){
            ...
            // file按钮
            this.filedivstyle={width:'100%',height:'40px','text-align':'center','line-height':'40px',background:'#00a0e9'};
            // 所有图片大盒子
            this.containstyle={width: '95%',height: 'auto',border: '1px solid #ccc',padding: '10px','box-sizing': 'border-box',margin: '10px 10px',overflow: 'hidden',};
            // 每一张图片盒子
            this.lisiboxstyle={margin: '10px',width: '100px',height: '100px',};
            // 进度条
            this.progressstyle={width:'0%',height:'20px',background:'#00a0e9'};
            // 删除按钮
            ...
            this.upbtn.onclick=function () {
                ...
                for(let i=0;i<that.data.length;i++){
                    ...
                    ajax.onload = function () {
                        document.querySelector('aside .img').value=ajax.response;
        ...
        createSelect(){
            ...
            this.filediv.style.cssText="width:"+this.filedivstyle.width+";height:"+this.filedivstyle.height+";text-align:"+this.filedivstyle['text-align']+";line-height:"+this.filedivstyle['line-height']+";background:"+this.filedivstyle.background+";border-radius:10px;position: relative;color:#fff;";
            this.filediv.innerText='上传头像';
            ...
            this.file.style.cssText="width: 100%;height: 100%;opacity: 0;position: absolute;left: 0;top: 0;color:#fff;";
        ...
        createUpbtn(){
            ...
            this.upbtn.style.cssText="width: 100%; height: 40px; text-align: center; line-height: 40px; background: #00a0e9; border-radius: 10px; position: relative;color:#fff;"

            let btn=document.createElement('button');
            btn.setAttribute('type','button');
            btn.style.cssText="width: 100%; height: 40px; text-align: center;line-height: 40px;border:none;background: #00a0e9; border-radius: 10px;color:#fff;font-size:16px";
            btn.innerText="上传";
